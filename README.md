# MIMIKEdgeClientPeer
 ...
 MIMIKEdgeClientPeer service library can help you interact with the following mimik services:
...
```swift
pod 'MIMIKEdgeClientPeer', '~> 13.2.1'
```

For Xcode 12.5.x compatibility

```swift
pod 'MIMIKEdgeClientPeer', '~> 12.5.1'
```
...
mimik
```
https://github.com/mimikgit/cocoapod-MIMIKEdgeClientPeer
```
